...
from franka_Intpromp_noAPF_nobounds import promp_pub 
...
class trajectory_optimization(promp_pub):
    ...
    def __init__(self, goal, const, tcam2, tsamples, tf, push_obs):
        ...
        self.object_list_agri = np.array([[goal[0]-0.0, goal[1]-0.3, goal[2]-0.1, 0.1], [goal[0]+0.0, goal[1]+0.3, goal[2]-0.1, 0.1]])  # sphere
    ...
    def calculate_total_cost(self, trajectory): # traj is flat
        ...
        #return 1.0 * push_cost +  1.0 * obstacle_cost + 0.5 * smooth_cost # Eq (1) in CHOMP paper, 1 + 0.5 + 2 nop, 
